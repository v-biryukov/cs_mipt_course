...
Это не самая лучшее решение задачи передачи информации от потока к потоку. Лучшие способы это использование \texttt{std::condition\_variable} или потокобезопасной очереди.
