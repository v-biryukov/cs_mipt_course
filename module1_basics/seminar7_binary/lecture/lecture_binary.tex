...
\subsubsection*{Сдвиги и неопределённое поведение}
Неопределённое поведение возникает при сдвигах отрицательного числа влево, а также если расстояние сдвига (правый операнд) отрицательно или больше или равно ширине типа данных.
...
\section*{Работа с участками памяти в C}


\subsection*{Массивы из \texttt{unsigned char} как участки памяти}
TODO
...
\subsection*{Стандартные функции \texttt{memset}, \texttt{memcpy} и \texttt{memmove}}
TODO


\subsection*{Указатели разных типов, указывающие на одно и то же место в памяти}
\iffalse
...
Битовые поля (англ. \textit{bit fields})

\section*{Каламбур типизации (Type punning)}
...
\newpage
\section*{Работа с бинарными файлами}
\texttt{fputc} . \\
\texttt{fgetc} . \\
