...
\begin{document}
\title{Семинар \#1: HelloWorld, ввод/вывод, операторы, циклы, массивы. Домашнее задание.\vspace{-5ex}}\date{}\maketitle
...
\noindent В каждой подзадаче этой задачи содержится пример кода на C, содержащий ошибку. Вам нужно определить в чём ошибка и приводит ли данная ошибка к неопределённому поведению.
...
\subsubsection{}
Эта программа должна была считывать число и печатать его квадрат, но программа почему-то работает не так как надо. Вместо того, чтобы просить одно число программа почему-то просит два числа.
