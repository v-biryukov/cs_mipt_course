...
\item Метод \texttt{getCount} которая возвращает количество вызовов метода \texttt{get} этого объекта.
\item Метод \texttt{setCount} которая возвращает количество вызовов метода \texttt{set} этого объекта.
\end{enumerate}
