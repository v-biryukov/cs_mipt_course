...
и методы:
\begin{enumerate}
\item Конструктор, который задаёт поля.
...
\item Метод \texttt{getCount} который возвращает количество вызовов метода \texttt{get} этого объекта.
\item Метод \texttt{setCount} который возвращает количество вызовов метода \texttt{set} этого объекта.
\end{enumerate}
